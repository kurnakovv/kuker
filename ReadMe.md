...
dotnet_diagnostic.KUK0006.syntax_kinds = method_invocation,object_creation,method_declaration # Optional | comma-separated syntax kinds; default is all supported kinds
