...
* Empty check | You can checking that the sequence is not empty via `.Any()`, `.Count` / `.Length` / pattern matching

## 🔗 Links
- Issues: [#27](https://github.com/kurnakovv/kuker/issues/27) | [#73](https://github.com/kurnakovv/kuker/issues/73)
