...
#pragma warning disable RCS0053, SA1117 // Parameter should not span multiple lines
    ...
    [InlineData(
        "NoReportWhenPropertyILoggerTypeDoesNotMatchContainingClassButHasSetter",
        """
        public ILogger<PaymentService> Logger { get; set; }
        """, 0, 0, 0, 0
    )]
    [InlineData(
        "NoReportWhenPropertyILoggerTypeDoesNotMatchContainingClassButHasInitSetter",
        """
        public ILogger<PaymentService> Logger { get; init; }
        """, 0, 0, 0, 0
    )]
    [InlineData(
        "ReportWhenPropertyILoggerTypeDoesNotMatchContainingClassButHasPrivateSetter",
        """
        public ILogger<PaymentService> Logger { get; private set; }
        """, 9, 20, 9, 34
    )]
    [InlineData(
        "ReportWhenPropertyILoggerTypeDoesNotMatchContainingClassButHasPrivateInitSetter",
        """
        public ILogger<PaymentService> Logger { get; private init; }
        """, 9, 20, 9, 34
    )]
    [InlineData(
...
#pragma warning restore RCS0053, SA1117 // Parameter should not span multiple lines
    ...
    [Fact]
    public async Task NoReportWhenPropertyUsesAliasTypeAndILoggerTypeDoesNotMatchContainingTypeButHasSetterAsync()
    {
        string testCode = """
            using LoggerAlias = TestNamespace.ILogger<TestNamespace.PaymentService>;
            ...
            public class OrderService
            {
                public LoggerAlias Logger { get; set; }
            }
    ...
    [Fact]
    public async Task NoReportWhenPropertyUsesAliasTypeAndILoggerTypeDoesNotMatchContainingTypeButHasInitSetterAsync()
    {
        string testCode = """
            using LoggerAlias = TestNamespace.ILogger<TestNamespace.PaymentService>;
            ...
            public class OrderService
            {
                public LoggerAlias Logger { get; init; }
            }
    ...
    [Fact]
    public async Task ReportWhenPropertyUsesAliasTypeAndILoggerTypeDoesNotMatchContainingTypeButHasPrivateSetterAsync()
    {
        string testCode = """
            using LoggerAlias = TestNamespace.ILogger<TestNamespace.PaymentService>;
            ...
            public class OrderService
            {
                public LoggerAlias Logger { get; private set; }
            }
    ...
    [Fact]
    public async Task ReportWhenPropertyUsesAliasTypeAndILoggerTypeDoesNotMatchContainingTypeButHasPrivateInitSetterAsync()
    {
        string testCode = """
            using LoggerAlias = TestNamespace.ILogger<TestNamespace.PaymentService>;
            ...
            public class OrderService
            {
                public LoggerAlias Logger { get; private init; }
            }
